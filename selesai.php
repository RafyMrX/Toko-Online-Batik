            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <table class="table table-stripped" style="background-color: #fff;">
                        ...
                        ?>
                        <tr>
                            <td colspan="5" style="text-align: right; font-weight: bold;">Ongkir = <?= number_format($ongkir); ?></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align: right; font-weight: bold;">Grand Total = <?= number_format($hasil + $ongkir); ?></td>
                        </tr>
                    </table>
